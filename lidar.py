from util import Vector2, compute_line, find_intersection, get_angle, distance, find_circle_intersection, find_n_nearest
import random
from math import cos, sin, atan2, pi
import pygame
from map import Wall, Wall_Line
...
class LIDAR:
	...
	def compute_line_collision(self, map, line, window):
			nearest_intersection = None
			min_dist = 1e6
			for obs in map.walls:
				p1, p2 = obs.p1, obs.p2
				wall_line = obs.get_line()
	...
	def scan_environment(self, t, map, window):
		"""
		...
		while self.angle < pi:
			...
			point = self.compute_line_collision(map, line, window)
